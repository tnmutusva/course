...
**The class representative can collect the marked scripts from office W16 on Friday, 3 December 2021.**



```{r echo=FALSE}
library(readxl)
cw21062021<- read_excel("cw21062021.xlsx")
library(DT)
datatable(cw21062021, rownames = FALSE,  options = list(pageLength = 100, scrollX=T,columnDefs=list(list(targets=2,visible=TRUE),list(className = 'dt-center', targets = 1:4))) )%>%
  formatStyle(
    'Quiz_1',
