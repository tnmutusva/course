---
title: '1202/1203: Coursework Marks'
output:
...
**CW=(BEST 3 TESTS + BEST ASSIGNMENT)/4**



```{r echo=FALSE}
library(readxl)
cw12022023<- read_excel("cw12022023.xlsx")
library(DT)
datatable(cw12022023, rownames = FALSE,  options = list(pageLength = 100, scrollX=T,columnDefs=list(list(targets=2,visible=TRUE),list(className = 'dt-center', targets = 1:9))) )%>%
  formatStyle(
    'Test_1',
