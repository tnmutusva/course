...
**Best 2 assignments/Quiz contribute 35%, Tests contribute 65%.**
...
library(DT)
datatable(cw21062022, rownames = FALSE,  options = list(pageLength = 100, scrollX=T,columnDefs=list(list(targets=2,visible=TRUE),list(className = 'dt-center', targets = 1:9))) )%>%
  formatStyle(
    'AS_1',
