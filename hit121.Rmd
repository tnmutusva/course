...
<center>
[![](121q.png){ width=100% }](https://docs.google.com/forms/d/e/1FAIpQLSesWlutMbkaeOw6tuJjrAcFf6P42kbI6QOfKEqbcyfNWfaNHw/viewform?usp=sf_link)
</center>
...
```{r echo=FALSE}
cw121q12<- read_excel("cw121q12.xlsx")
library(DT)
datatable(cw121q12, rownames = FALSE,caption = 'For fast access, type your surname in the search box.',  options = list(order = list(list(1, 'asc')),pageLength = 5, scrollX=T,columnDefs=list(list(className = 'dt-center', targets = 2:4))),colnames= c("Registration","Surname","Department","Quiz 1","Quiz 2") ) %>%
  formatStyle(
    'Quiz_1',
