...
[Laplace Transforms ](https://spark.adobe.com/page/atrXte6NsipNh/)
...
```{r echo=FALSE}
cw121q1234<- read_excel("cw121q1234.xlsx")
library(DT)
datatable(cw121q1234, rownames = FALSE,caption = 'For fast access, type your surname in the search box.',  options = list(order = list(list(1, 'asc')),pageLength = 100, scrollX=T,columnDefs=list(list(className = 'dt-center', targets = 2:5))),colnames= c("Registration","Surname","Department","Quiz 1","Quiz 2","Quiz 3","Quiz 4","CW") ) %>%
  formatStyle(
    'Quiz_1',
