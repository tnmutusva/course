...
```{r echo=FALSE}
cw1212020final<- read_excel("hit1212020cwfinal.xlsx")
library(DT)
datatable(cw1212020final, rownames = FALSE,caption = 'For fast access, type your surname in the search box.',  options = list(order = list(list(1, 'asc')),pageLength = 100, scrollX=T,columnDefs=list(list(className = 'dt-center', targets = 2:5))),colnames= c("Registration","Surname","Department","Quiz 1","Quiz 2","Quiz 3","Quiz 4","CW") ) %>%
  formatStyle(
    'Quiz_1',
