...
library(DT)
datatable(cw12022022, rownames = FALSE,  options = list(pageLength = 100, scrollX=T,columnDefs=list(list(targets=2,visible=TRUE),list(className = 'dt-center', targets = 1:4))) )%>%
  formatStyle(
    'Test_1',
