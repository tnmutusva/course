...
**CW is average of best 3 Tests**


```{r echo=FALSE}
library(readxl)
cw12022022<- read_excel("cw12022022.xlsx")
library(DT)
datatable(cw12022022, rownames = FALSE,  options = list(pageLength = 100, scrollX=T,columnDefs=list(list(targets=2,visible=TRUE),list(className = 'dt-center', targets = 1:7))) )%>%
  formatStyle(
    'Test_1',
